...
export function EntrenamientosHeader() {
  return (
    <div className="capacitacion">
      ...
      <Button specificClass="btn__capacitacion-main-banner">CONTÁCTANOS</Button>
    </div>
  );
}
...
export function EntrenamientosEntrenamientosOnline() {
  return (
    <div className="entrenamientos__entrenamientos-online">
      <img
      ...
      <div className="entrenamientos-entrenamiento__card-text">
        ...
        <p className="entrenamiento__card-text-bold">
          Debido a las limitaciones de movilidad y el distanciamiento social que
          hemos estado experimentando en el mundo en los últimos meses, Prédica
          Fiel ha diseñado un entrenamiento online para predicadores con el
          objetivo de desarrollar las habilidades de los mismos semana tras
          semana.
        </p>
        <p className="entrenamiento__card-text-normal">
          ...
          específicos del libro de Marcos, así como también harán una exposición
          de veinte minutos, para las cuáles recibirán retroalimentación.
        </p>
...
export function PlanHabana() {
  return (
    <div className="plan-habana">
      <div className="plan-habana-banner">
        <div className="plan-habana-banner__text">
          <h1 className="plan-habana-banner__header">PLAN HABANA</h1>
          <p className="modalidad">
            Modalidad:{" "}
            <span className="plan-habana-banner--bold">Presencial,</span> Cuba.
          </p>
        ...
        <div className="plan-habana-banner__imagen-container">
          <img
            className="plan-habana-banner__imagen"
  ...
  return (
    <div>
      <div className="internado">
        ...
        <div className="internado__images-container">
          <img
